...
if __name__=="__main__":
    ...
    parser.add_argument('--conf', type=float, default=0.001, help='object confidence threshold')#以前是0.4
    parser.add_argument('--iou', type=float, default=0.4, help='IOU threshold for NMS')#以前是0.4
